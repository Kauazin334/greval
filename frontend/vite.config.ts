...
const visualEditsDisabled = process.env.ENABLE_VISUAL_EDITS !== "true";
...
export default defineConfig(async () => {
  ...
  return {
    // GitHub Pages serves this repository at /greval/, while local development
    // remains at the domain root. Without this, built JS/CSS assets resolve to
    // /assets and the published page cannot load the React application.
    base: process.env.GITHUB_ACTIONS === "true" ? "/greval/" : "/",
    plugins: [
      react(),
      tailwindcss(),
